import { GoodPartyTeamMembersRaw, TeamMember, Transformer, GoodPartyTeamMembersAugmented } from "../content.types";
...
> = (teamMembersRaw: GoodPartyTeamMembersRaw[]): GoodPartyTeamMembersAugmented[] => {
