...
describe('ContactsService', () => {
  ...
  describe('getConstituentIssues', () => {
    ...
    it('calls prisma with personId, electedOfficeId, CONSTITUENT sender, and pollIssues some', async () => {
    ...
    it('respects take and returns nextCursor when more results exist', async () => {
      const sentAt = new Date('2026-02-01T12:00:00Z')
      mockPrismaService.pollIndividualMessage.findMany.mockResolvedValue([
        {
          sentAt,
    ...
    it('respects after cursor and returns next page', async () => {
      const sentAt = new Date('2026-02-01T12:00:00Z')
      mockPrismaService.pollIndividualMessage.findMany.mockResolvedValue([
        {
          sentAt,
